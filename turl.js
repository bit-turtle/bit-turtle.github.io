...
var ASM_CONSTS = {
  81820: () => { var input = prompt("Input:"); if (input == null) return ""; else return stringToNewUTF8(input) },  
 81919: () => { var input = prompt("Enter Turl Code [Type nothing to finish]:"); if (input == null) return ""; else return stringToNewUTF8(input); }
};
